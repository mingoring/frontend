...
import '../../../onboarding/presentation/constants/signup_screen_constants.dart';
import '../../../onboarding/presentation/viewmodels/signup_viewmodel.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            if (response != null) ...[
              ...
              _InfoRow('agreedAt (UTC)', response.agreedAt),
            ],
          ],
        ),
      ),
